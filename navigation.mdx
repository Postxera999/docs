...
The Navigation Bar is used at the top of the page to show brand identity, the current page title or selector, and common actions (share, go home, etc.). This component mirrors the Figma design and provides two color themes (Black/White) and two functional variants (Default/Title).
...
![Snipaste 2025 10 21 15 38 09 Pn](/images/Snipaste_2025-10-21_15-38-09.png)
...
<iframe
  ...
  allowFullScreen
  style={{ width: '100%', borderRadius: '0.5rem', border: 'none' }}
></iframe>
