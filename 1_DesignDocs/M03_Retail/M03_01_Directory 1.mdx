...
| **Character Limit**    | 50 characters (for the category name itself)                                                                           |
| **Input Validation**   | N/A                                                                                                                    |
| **Data Source**        | Selected by CMS editor from a Global Category List configured by the system administrator.                             |
| **Dependencies**       | Used in search results, merchant list view, merchant detail pages, and payment confirmation screens, Featured Listings |
...
| **Character Limit**    | N/A (Fixed text: "Closed Now" or "Open Now")                                                                           |
| **Input Validation**   | N/A                                                                                                                    |
...
| **Specification Item** | **Floor**                                                                                                              | **Shop Number**                                                                                                                                            | **Property Zone**                     |
| ---------------------- | ---------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------- |
| **Field Type**         | Dropdown/Single Select                                                                                                 | Text Input                                                                                                                                                 | Dropdown/Single Select                |
| **Character Limit**    | N/A                                                                                                                    | All fields accept alphanumeric input (A-Z, 0-9)(except standard punctuation and brand symbols like ® or ™). Leading/trailing spaces automatically trimmed. | N/A                                   |
| **Input Validation**   | N/A                                                                                                                    | N/A                                                                                                                                                        | N/A                                   |
| **Data Source**        | Input manually by CMS editor for each of the three components: Floor, Shop Number, and Property Zone.                  | The same as `Floor` and `Property Zone`                                                                                                                    | The same as `Floor` and `Shop Number` |
| **Dependencies**       | Used in search results, merchant list view, merchant detail pages, and payment confirmation screens, Featured Listings | The same as `Floor` and `Property Zone`                                                                                                                    | The same as `Floor` and `Shop Number` |
